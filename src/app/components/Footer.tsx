...
const socialLinks = [
  ...
  {
    href: "https://www.instagram.com/elgiovr/",
    label: "Instagram",
    icon: InstagramIcon,
  },
...
export default function Footer({ darkMode }: FooterProps) {
  ...
  return (
    <footer className="relative z-10 py-10">
      <div
        className="section-shell rounded-[2rem] border p-7 md:p-10"
        style={{
      ...
      >
        <div className="grid gap-10 md:grid-cols-[1fr_auto] md:items-end">
          <div>
            <div className="mb-5">
              <VisitCounter darkMode={darkMode} />
            </div>
        ...
        <div
          className="mt-10 border-t pt-6 text-sm muted"
          style={{ borderColor: "var(--line-color)" }}
        >
          &copy;2026. {t("footer.madeBy")}{" "}
          <span className="font-bold">Gio Vazquez</span>.
        </div>
      </div>
    </footer>
  );
